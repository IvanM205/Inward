...
const en = {
  ...
  'intake.hoursHint': 'hours in a week',
  ...
  'path.introBody': 'Seven days each. One short reading a day, one question, one act in the world. One day at a time — the pace is the point.',
  'path.begunTerminal': 'The path is open. Day one waits on the threshold.',
  'path.questionHint': 'for you, not for the app',
  'path.closingPrompt': 'Seven days walked. What did the path leave with you?',
...
const sk: Partial<Record<StringKey, string>> = {
  ...
  'intake.hoursHint': 'hodiny za týždeň',
  ...
  'path.introBody': 'Vždy sedem dní. Jedno krátke čítanie denne, jedna otázka, jeden čin vo svete. Deň za dňom — tempo je pointa.',
  'path.begunTerminal': 'Cesta je otvorená. Prvý deň čaká na prahu.',
  'path.questionHint': 'pre teba, nie pre aplikáciu',
  'path.closingPrompt': 'Sedem prejdených dní. Čo ti cesta nechala?',
  'path.dayAct': 'čin dňa',
